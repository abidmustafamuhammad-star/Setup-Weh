...
app.post('/api/webhook/pakasir', async (req, res) => {
  ...
  try {
    ...
    // WAJIB verifikasi langsung ke Pakasir — jangan pernah percaya body webhook mentah.
    // Sebelumnya `verified` dihitung tapi tidak pernah dipakai untuk menolak request,
    // artinya siapapun yang tahu URL webhook bisa memicu penambahan saldo palsu.
    let verified = false;
    try {
